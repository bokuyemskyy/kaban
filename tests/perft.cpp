...
TEST(Perft, PerftMicroset) {
    Engine engine;
    engine.set_position("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w");
...
TEST(Perft, PerftMegaset) {
    Engine engine;
    engine.set_position("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR");
    ...
    engine.set_position("4k2r/8/8/8/8/8/8/4K3 w k - 0 1");
    ...
    engine.set_position("r3k3/8/8/8/8/8/8/4K3 w q - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    ...
    engine.set_position("4k3/8/8/8/8/8/8/R3K2R w KQ - 0 1");
    ...
    engine.set_position("r3k2r/8/8/8/8/8/8/4K3 w kq - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    ...
    engine.set_position("8/8/8/8/8/8/6k1/4K2R w K - 0 1");
    ...
    engine.set_position("8/8/8/8/8/8/1k6/R3K3 w Q - 0 1");
    EXPECT_EQ(engine.perft(1), 15);
    ...
    engine.set_position("4k2r/6K1/8/8/8/8/8/8 w k - 0 1");
    ...
    engine.set_position("r3k3/1K6/8/8/8/8/8/8 w q - 0 1");
    ...
    engine.set_position("r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1");
    EXPECT_EQ(engine.perft(1), 26);
    ...
    engine.set_position("r3k2r/8/8/8/8/8/8/1R2K2R w Kkq - 0 1");
    ...
    engine.set_position("r3k2r/8/8/8/8/8/8/2R1K2R w Kkq - 0 1");
    EXPECT_EQ(engine.perft(1), 25);
    ...
    engine.set_position("r3k2r/8/8/8/8/8/8/R3K1R1 w Qkq - 0 1");
    EXPECT_EQ(engine.perft(1), 25);
    ...
    engine.set_position("1r2k2r/8/8/8/8/8/8/R3K2R w KQk - 0 1");
    EXPECT_EQ(engine.perft(1), 26);
    ...
    engine.set_position("2r1k2r/8/8/8/8/8/8/R3K2R w KQk - 0 1");
    EXPECT_EQ(engine.perft(1), 25);
    ...
    engine.set_position("r3k1r1/8/8/8/8/8/8/R3K2R w KQq - 0 1");
    EXPECT_EQ(engine.perft(1), 25);
    EXPECT_EQ(engine.perft(2), 560);
    ...
    engine.set_position("4k3/8/8/8/8/8/8/4K2R b K - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 75);
    EXPECT_EQ(engine.perft(3), 459);
    EXPECT_EQ(engine.perft(4), 8290);
    ...
    engine.set_position("4k3/8/8/8/8/8/8/R3K3 b Q - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 80);
    EXPECT_EQ(engine.perft(3), 493);
    EXPECT_EQ(engine.perft(4), 8897);
    ...
    engine.set_position("4k2r/8/8/8/8/8/8/4K3 b k - 0 1");
    EXPECT_EQ(engine.perft(1), 15);
    EXPECT_EQ(engine.perft(2), 66);
    EXPECT_EQ(engine.perft(3), 1197);
    EXPECT_EQ(engine.perft(4), 7059);
    ...
    engine.set_position("r3k3/8/8/8/8/8/8/4K3 b q - 0 1");
    EXPECT_EQ(engine.perft(1), 16);
    EXPECT_EQ(engine.perft(2), 71);
    EXPECT_EQ(engine.perft(3), 1287);
    EXPECT_EQ(engine.perft(4), 7626);
    ...
    engine.set_position("4k3/8/8/8/8/8/8/R3K2R b KQ - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 130);
    EXPECT_EQ(engine.perft(3), 782);
    EXPECT_EQ(engine.perft(4), 22180);
    ...
    engine.set_position("r3k2r/8/8/8/8/8/8/4K3 b kq - 0 1");
    EXPECT_EQ(engine.perft(1), 26);
    EXPECT_EQ(engine.perft(2), 112);
    EXPECT_EQ(engine.perft(3), 3189);
    EXPECT_EQ(engine.perft(4), 17945);
    ...
    engine.set_position("8/8/8/8/8/8/6k1/4K2R b K - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    EXPECT_EQ(engine.perft(2), 32);
    EXPECT_EQ(engine.perft(3), 134);
    EXPECT_EQ(engine.perft(4), 2073);
    ...
    engine.set_position("8/8/8/8/8/8/1k6/R3K3 b Q - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 49);
    EXPECT_EQ(engine.perft(3), 243);
    EXPECT_EQ(engine.perft(4), 3991);
    ...
    engine.set_position("4k2r/6K1/8/8/8/8/8/8 b k - 0 1");
    EXPECT_EQ(engine.perft(1), 12);
    EXPECT_EQ(engine.perft(2), 38);
    EXPECT_EQ(engine.perft(3), 564);
    EXPECT_EQ(engine.perft(4), 2219);
    ...
    engine.set_position("r3k3/1K6/8/8/8/8/8/8 b q - 0 1");
    EXPECT_EQ(engine.perft(1), 15);
    EXPECT_EQ(engine.perft(2), 65);
    EXPECT_EQ(engine.perft(3), 1018);
    EXPECT_EQ(engine.perft(4), 4573);
    ...
    engine.set_position("r3k2r/8/8/8/8/8/8/R3K2R b KQkq - 0 1");
    EXPECT_EQ(engine.perft(1), 26);
    EXPECT_EQ(engine.perft(2), 568);
    EXPECT_EQ(engine.perft(3), 13744);
    EXPECT_EQ(engine.perft(4), 314346);
    ...
    engine.set_position("r3k2r/8/8/8/8/8/8/1R2K2R b Kkq - 0 1");
    EXPECT_EQ(engine.perft(1), 26);
    EXPECT_EQ(engine.perft(2), 583);
    EXPECT_EQ(engine.perft(3), 14252);
    EXPECT_EQ(engine.perft(4), 334705);
    ...
    engine.set_position("r3k2r/8/8/8/8/8/8/2R1K2R b Kkq - 0 1");
    EXPECT_EQ(engine.perft(1), 25);
    EXPECT_EQ(engine.perft(2), 560);
    EXPECT_EQ(engine.perft(3), 13592);
    EXPECT_EQ(engine.perft(4), 317324);
    ...
    engine.set_position("r3k2r/8/8/8/8/8/8/R3K1R1 b Qkq - 0 1");
    EXPECT_EQ(engine.perft(1), 25);
    EXPECT_EQ(engine.perft(2), 560);
    EXPECT_EQ(engine.perft(3), 13607);
    EXPECT_EQ(engine.perft(4), 320792);
    ...
    engine.set_position("1r2k2r/8/8/8/8/8/8/R3K2R b KQk - 0 1");
    EXPECT_EQ(engine.perft(1), 25);
    EXPECT_EQ(engine.perft(2), 567);
    EXPECT_EQ(engine.perft(3), 14095);
    EXPECT_EQ(engine.perft(4), 328965);
    ...
    engine.set_position("2r1k2r/8/8/8/8/8/8/R3K2R b KQk - 0 1");
    EXPECT_EQ(engine.perft(1), 25);
    EXPECT_EQ(engine.perft(2), 548);
    EXPECT_EQ(engine.perft(3), 13502);
    EXPECT_EQ(engine.perft(4), 312835);
    ...
    engine.set_position("r3k1r1/8/8/8/8/8/8/R3K2R b KQq - 0 1");
    EXPECT_EQ(engine.perft(1), 25);
    EXPECT_EQ(engine.perft(2), 547);
    EXPECT_EQ(engine.perft(3), 13579);
    EXPECT_EQ(engine.perft(4), 316214);
    ...
    engine.set_position("8/1n4N1/2k5/8/8/5K2/1N4n1/8 w - - 0 1");
    ...
    engine.set_position("8/1k6/8/5N2/8/4n3/8/2K5 w - - 0 1");
    ...
    engine.set_position("8/8/4k3/3Nn3/3nN3/4K3/8/8 w - - 0 1");
    ...
    engine.set_position("K7/8/2n5/1n6/8/8/8/k6N w - - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    ...
    engine.set_position("8/1n4N1/2k5/8/8/5K2/1N4n1/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 15);
    ...
    engine.set_position("8/1k6/8/5N2/8/4n3/8/2K5 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 16);
    ...
    engine.set_position("8/8/3K4/3Nn3/3nN3/4k3/8/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    ...
    engine.set_position("K7/8/2n5/1n6/8/8/8/k6N b - - 0 1");
    EXPECT_EQ(engine.perft(1), 17);
    EXPECT_EQ(engine.perft(2), 54);
    EXPECT_EQ(engine.perft(3), 835);
    EXPECT_EQ(engine.perft(4), 5910);
    ...
    engine.set_position("B6b/8/8/8/2K5/4k3/8/b6B w - - 0 1");
    EXPECT_EQ(engine.perft(1), 17);
    ...
    engine.set_position("8/8/1B6/7b/7k/8/2B1b3/7K w - - 0 1");
    ...
    engine.set_position("k7/B7/1B6/1B6/8/8/8/K6b w - - 0 1");
    EXPECT_EQ(engine.perft(1), 21);
    ...
    engine.set_position("B6b/8/8/8/2K5/5k2/8/b6B b - - 0 1");
    ...
    engine.set_position("8/8/1B6/7b/7k/8/2B1b3/7K b - - 0 1");
    EXPECT_EQ(engine.perft(1), 17);
    ...
    engine.set_position("k7/B7/1B6/1B6/8/8/8/K6b b - - 0 1");
    EXPECT_EQ(engine.perft(1), 7);
    EXPECT_EQ(engine.perft(2), 143);
    EXPECT_EQ(engine.perft(3), 1416);
    EXPECT_EQ(engine.perft(4), 31787);
    ...
    engine.set_position("7k/RR6/8/8/8/8/rr6/7K w - - 0 1");
    EXPECT_EQ(engine.perft(1), 19);
    ...
    engine.set_position("R6r/8/8/2K5/5k2/8/8/r6R w - - 0 1");
    ...
    engine.set_position("7k/RR6/8/8/8/8/rr6/7K b - - 0 1");
    EXPECT_EQ(engine.perft(1), 19);
    EXPECT_EQ(engine.perft(2), 275);
    EXPECT_EQ(engine.perft(3), 5300);
    EXPECT_EQ(engine.perft(4), 104342);
    ...
    engine.set_position("R6r/8/8/2K5/5k2/8/8/r6R b - - 0 1");
    EXPECT_EQ(engine.perft(1), 36);
    EXPECT_EQ(engine.perft(2), 1027);
    ...
    engine.set_position("6kq/8/8/8/8/8/8/7K w - - 0 1");
    ...
    engine.set_position("6KQ/8/8/8/8/8/8/7k b - - 0 1");
    EXPECT_EQ(engine.perft(1), 2);
    EXPECT_EQ(engine.perft(2), 36);
    EXPECT_EQ(engine.perft(3), 143);
    EXPECT_EQ(engine.perft(4), 3637);
    ...
    engine.set_position("K7/8/8/3Q4/4q3/8/8/7k w - - 0 1");
    EXPECT_EQ(engine.perft(1), 6);
    ...
    engine.set_position("6qk/8/8/8/8/8/8/7K b - - 0 1");
    ...
    engine.set_position("K7/8/8/3Q4/4q3/8/8/7k b - - 0 1");
    EXPECT_EQ(engine.perft(1), 6);
    EXPECT_EQ(engine.perft(2), 35);
    EXPECT_EQ(engine.perft(3), 495);
    EXPECT_EQ(engine.perft(4), 8349);
    ...
    engine.set_position("8/8/8/8/8/K7/P7/k7 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    ...
    engine.set_position("8/8/8/8/8/7K/7P/7k w - - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    EXPECT_EQ(engine.perft(2), 7);
    EXPECT_EQ(engine.perft(3), 43);
    EXPECT_EQ(engine.perft(4), 199);
    ...
    engine.set_position("K7/p7/k7/8/8/8/8/8 w - - 0 1");
    ...
    engine.set_position("7K/7p/7k/8/8/8/8/8 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 1);
    EXPECT_EQ(engine.perft(2), 3);
    EXPECT_EQ(engine.perft(3), 12);
    EXPECT_EQ(engine.perft(4), 80);
    ...
    engine.set_position("8/2k1p3/3pP3/3P2K1/8/8/8/8 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 7);
    EXPECT_EQ(engine.perft(2), 35);
    ...
    engine.set_position("8/8/8/8/8/K7/P7/k7 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 1);
    EXPECT_EQ(engine.perft(2), 3);
    EXPECT_EQ(engine.perft(3), 12);
    EXPECT_EQ(engine.perft(4), 80);
    ...
    engine.set_position("8/8/8/8/8/7K/7P/7k b - - 0 1");
    EXPECT_EQ(engine.perft(1), 1);
    EXPECT_EQ(engine.perft(2), 3);
    EXPECT_EQ(engine.perft(3), 12);
    EXPECT_EQ(engine.perft(4), 80);
    ...
    engine.set_position("K7/p7/k7/8/8/8/8/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    EXPECT_EQ(engine.perft(2), 7);
    EXPECT_EQ(engine.perft(3), 43);
    EXPECT_EQ(engine.perft(4), 199);
    ...
    engine.set_position("7K/7p/7k/8/8/8/8/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    EXPECT_EQ(engine.perft(2), 7);
    EXPECT_EQ(engine.perft(3), 43);
    EXPECT_EQ(engine.perft(4), 199);
    ...
    engine.set_position("8/2k1p3/3pP3/3P2K1/8/8/8/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 35);
    ...
    engine.set_position("8/8/8/8/8/4k3/4P3/4K3 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 2);
    ...
    engine.set_position("4k3/4p3/4K3/8/8/8/8/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 2);
    EXPECT_EQ(engine.perft(2), 8);
    EXPECT_EQ(engine.perft(3), 44);
    EXPECT_EQ(engine.perft(4), 282);
    ...
    engine.set_position("8/8/7k/7p/7P/7K/8/8 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    ...
    engine.set_position("8/8/k7/p7/P7/K7/8/8 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    EXPECT_EQ(engine.perft(2), 9);
    EXPECT_EQ(engine.perft(3), 57);
    EXPECT_EQ(engine.perft(4), 360);
    ...
    engine.set_position("8/8/3k4/3p4/3P4/3K4/8/8 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    ...
    engine.set_position("8/3k4/3p4/8/3P4/3K4/8/8 w - - 0 1");
    ...
    engine.set_position("8/8/3k4/3p4/8/3P4/3K4/8 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 8);
    EXPECT_EQ(engine.perft(2), 61);
    ...
    engine.set_position("k7/8/3p4/8/3P4/8/8/7K w - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    ...
    engine.set_position("8/8/7k/7p/7P/7K/8/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    EXPECT_EQ(engine.perft(2), 9);
    EXPECT_EQ(engine.perft(3), 57);
    EXPECT_EQ(engine.perft(4), 360);
    ...
    engine.set_position("8/8/k7/p7/P7/K7/8/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    EXPECT_EQ(engine.perft(2), 9);
    EXPECT_EQ(engine.perft(3), 57);
    EXPECT_EQ(engine.perft(4), 360);
    ...
    engine.set_position("8/8/3k4/3p4/3P4/3K4/8/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 25);
    EXPECT_EQ(engine.perft(3), 180);
    EXPECT_EQ(engine.perft(4), 1294);
    ...
    engine.set_position("8/3k4/3p4/8/3P4/3K4/8/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 8);
    EXPECT_EQ(engine.perft(2), 61);
    EXPECT_EQ(engine.perft(3), 411);
    EXPECT_EQ(engine.perft(4), 3213);
    ...
    engine.set_position("8/8/3k4/3p4/8/3P4/3K4/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 8);
    EXPECT_EQ(engine.perft(2), 61);
    EXPECT_EQ(engine.perft(3), 483);
    EXPECT_EQ(engine.perft(4), 3213);
    ...
    engine.set_position("k7/8/3p4/8/3P4/8/8/7K b - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 15);
    ...
    engine.set_position("7k/3p4/8/8/3P4/8/8/K7 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    ...
    engine.set_position("7k/8/8/3p4/8/8/3P4/K7 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 19);
    ...
    engine.set_position("k7/8/8/7p/6P1/8/8/K7 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    ...
    engine.set_position("k7/8/7p/8/8/6P1/8/K7 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    ...
    engine.set_position("k7/8/8/6p1/7P/8/8/K7 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 22);
    EXPECT_EQ(engine.perft(3), 139);
    EXPECT_EQ(engine.perft(4), 877);
    ...
    engine.set_position("k7/8/6p1/8/8/7P/8/K7 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 16);
    EXPECT_EQ(engine.perft(3), 101);
    EXPECT_EQ(engine.perft(4), 637);
    ...
    engine.set_position("k7/8/8/3p4/4p3/8/8/7K w - - 0 1");
    EXPECT_EQ(engine.perft(1), 3);
    EXPECT_EQ(engine.perft(2), 15);
    ...
    engine.set_position("k7/8/3p4/8/8/4P3/8/7K w - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 16);
    EXPECT_EQ(engine.perft(3), 101);
    EXPECT_EQ(engine.perft(4), 637);
    ...
    engine.set_position("7k/3p4/8/8/3P4/8/8/K7 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 19);
    EXPECT_EQ(engine.perft(3), 117);
    EXPECT_EQ(engine.perft(4), 720);
    ...
    engine.set_position("7k/8/8/3p4/8/8/3P4/K7 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 19);
    EXPECT_EQ(engine.perft(3), 117);
    ...
    engine.set_position("k7/8/8/7p/6P1/8/8/K7 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 22);
    EXPECT_EQ(engine.perft(3), 139);
    EXPECT_EQ(engine.perft(4), 877);
    ...
    engine.set_position("k7/8/7p/8/8/6P1/8/K7 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 16);
    EXPECT_EQ(engine.perft(3), 101);
    EXPECT_EQ(engine.perft(4), 637);
    ...
    engine.set_position("k7/8/8/6p1/7P/8/8/K7 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 22);
    EXPECT_EQ(engine.perft(3), 139);
    EXPECT_EQ(engine.perft(4), 877);
    ...
    engine.set_position("k7/8/6p1/8/8/7P/8/K7 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 16);
    EXPECT_EQ(engine.perft(3), 101);
    EXPECT_EQ(engine.perft(4), 637);
    ...
    engine.set_position("k7/8/8/3p4/4p3/8/8/7K b - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 15);
    ...
    engine.set_position("k7/8/3p4/8/8/4P3/8/7K b - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 16);
    EXPECT_EQ(engine.perft(3), 101);
    EXPECT_EQ(engine.perft(4), 637);
    ...
    engine.set_position("7k/8/8/p7/1P6/8/8/7K w - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 22);
    EXPECT_EQ(engine.perft(3), 139);
    EXPECT_EQ(engine.perft(4), 877);
    ...
    engine.set_position("7k/8/p7/8/8/1P6/8/7K w - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 16);
    EXPECT_EQ(engine.perft(3), 101);
    EXPECT_EQ(engine.perft(4), 637);
    ...
    engine.set_position("7k/8/8/1p6/P7/8/8/7K w - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 22);
    EXPECT_EQ(engine.perft(3), 139);
    EXPECT_EQ(engine.perft(4), 877);
    ...
    engine.set_position("7k/8/1p6/8/8/P7/8/7K w - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 16);
    EXPECT_EQ(engine.perft(3), 101);
    EXPECT_EQ(engine.perft(4), 637);
    ...
    engine.set_position("k7/7p/8/8/8/8/6P1/K7 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 25);
    ...
    engine.set_position("k7/6p1/8/8/8/8/7P/K7 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 25);
    EXPECT_EQ(engine.perft(3), 161);
    EXPECT_EQ(engine.perft(4), 1035);
    ...
    engine.set_position("3k4/3pp3/8/8/8/8/3PP3/3K4 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 7);
    EXPECT_EQ(engine.perft(2), 49);
    ...
    engine.set_position("7k/8/8/p7/1P6/8/8/7K b - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 22);
    EXPECT_EQ(engine.perft(3), 139);
    EXPECT_EQ(engine.perft(4), 877);
    ...
    engine.set_position("7k/8/p7/8/8/1P6/8/7K b - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 16);
    EXPECT_EQ(engine.perft(3), 101);
    EXPECT_EQ(engine.perft(4), 637);
    ...
    engine.set_position("7k/8/8/1p6/P7/8/8/7K b - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 22);
    EXPECT_EQ(engine.perft(3), 139);
    EXPECT_EQ(engine.perft(4), 877);
    ...
    engine.set_position("7k/8/1p6/8/8/P7/8/7K b - - 0 1");
    EXPECT_EQ(engine.perft(1), 4);
    EXPECT_EQ(engine.perft(2), 16);
    EXPECT_EQ(engine.perft(3), 101);
    EXPECT_EQ(engine.perft(4), 637);
    ...
    engine.set_position("k7/7p/8/8/8/8/6P1/K7 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 25);
    EXPECT_EQ(engine.perft(3), 161);
    EXPECT_EQ(engine.perft(4), 1035);
    ...
    engine.set_position("k7/6p1/8/8/8/8/7P/K7 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 5);
    EXPECT_EQ(engine.perft(2), 25);
    EXPECT_EQ(engine.perft(3), 161);
    EXPECT_EQ(engine.perft(4), 1035);
    ...
    engine.set_position("3k4/3pp3/8/8/8/8/3PP3/3K4 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 7);
    EXPECT_EQ(engine.perft(2), 49);
    EXPECT_EQ(engine.perft(3), 378);
    EXPECT_EQ(engine.perft(4), 2902);
    ...
    engine.set_position("8/Pk6/8/8/8/8/6Kp/8 w - - 0 1");
    EXPECT_EQ(engine.perft(1), 11);
    ...
    engine.set_position("n1n5/1Pk5/8/8/8/8/5Kp1/5N1N w - - 0 1");
    ...
    engine.set_position("8/PPPk4/8/8/8/8/4Kppp/8 w - - 0 1");
    ...
    engine.set_position("n1n5/PPPk4/8/8/8/8/4Kppp/5N1N w - - 0 1");
    EXPECT_EQ(engine.perft(1), 24);
    ...
    engine.set_position("8/Pk6/8/8/8/8/6Kp/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 11);
    EXPECT_EQ(engine.perft(2), 97);
    EXPECT_EQ(engine.perft(3), 887);
    EXPECT_EQ(engine.perft(4), 8048);
    ...
    engine.set_position("n1n5/1Pk5/8/8/8/8/5Kp1/5N1N b - - 0 1");
    EXPECT_EQ(engine.perft(1), 24);
    EXPECT_EQ(engine.perft(2), 421);
    EXPECT_EQ(engine.perft(3), 7421);
    EXPECT_EQ(engine.perft(4), 124608);
    ...
    engine.set_position("8/PPPk4/8/8/8/8/4Kppp/8 b - - 0 1");
    EXPECT_EQ(engine.perft(1), 18);
    EXPECT_EQ(engine.perft(2), 270);
    EXPECT_EQ(engine.perft(3), 4699);
    EXPECT_EQ(engine.perft(4), 79355);
    ...
    engine.set_position("n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1");
    EXPECT_EQ(engine.perft(1), 24);
    EXPECT_EQ(engine.perft(2), 496);
    EXPECT_EQ(engine.perft(3), 9483);
    EXPECT_EQ(engine.perft(4), 182838);
